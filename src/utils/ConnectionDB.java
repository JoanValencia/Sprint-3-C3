...
public class ConnectionDB {
    ...
    public static Connection getConnection() {
        ...
        // conectar
        try {
            String credentials_path = System.getProperty("user.dir") + "/src/utils/credenciales.json";
            ...
            String schema_name = "reto_4";
            String dbURL = "jdbc:mysql://"+host+":"+port+"/"+schema_name;
            
            conn = DriverManager.getConnection(dbURL, username, password);
            /*PARA PROBAR LA CONEXIÓN DESCOMENTAREAR LAS SIGUIENTES DOS LÍNEAS */
            //if( conn != null ) 
